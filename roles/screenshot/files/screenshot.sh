...
while true; do
   raspi2png -h 200 -w 400 -c 5 --pngname /var/www/html/addon/screen/screenshot_tmp.png  || cp -f /var/www/html/addon/error.png /var/www/html/addon/screen/screenshot_tmp.png
